...
NOTE:  `Hardware ID not available`NetApp 하이브리드 클라우드 제어에 표시된 또는 `Unable to Detect` 오류를 해결해야 할 수 link:task_hcc_edit_bmc_info.html["컴퓨팅 노드의 BMC 자격 증명을 변경합니다"]있습니다.
...
NOTE: 또는 NetApp 하이브리드 클라우드 제어 UI에서 인벤토리가 업데이트될 때까지 15분 정도 기다릴 수 있습니다.
