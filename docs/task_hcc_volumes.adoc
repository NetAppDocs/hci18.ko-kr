...
+
에 대한 정보를 link:concept_hci_volume_access_groups.html["볼륨 액세스 그룹"]참조하십시오.

.. * 계정 *: 사용자 계정을 볼 수 있으며, 이 사용자 계정을 통해 클라이언트가 노드의 볼륨에 연결할 수 있습니다. 볼륨을 생성하면 특정 사용자 계정에 할당됩니다.
+
에 대한 정보를 link:concept_cg_hci_accounts.html["NetApp HCI 사용자 계정"]참조하십시오.
...
+
에 대한 자세한 https://docs.netapp.com/sfe-122/topic/com.netapp.doc.sfe-ug/GUID-EBCB1031-1B2D-472C-92E3-E0CB52B4156C.html["액세스 그룹, 이니시에이터 및 CHAP 인증 방법"^] 내용은 _NetApp Element 사용 설명서_ 를 참조하십시오.

.. * QoS 정책 *: 볼륨에 적용된 QoS 정책을 확인할 수 있습니다. QoS 정책은 여러 볼륨에 최소 IOPS, 최대 IOPS 및 버스트 IOPS에 대한 표준화된 설정을 적용합니다.
+
에 대한 정보를 link:concept_hci_performance#qos-performance.html["성능 및 QoS 정책"]참조하십시오.

+
에 대한 자세한 https://docs.netapp.com/sfe-122/topic/com.netapp.doc.sfe-ug/GUID-C90C0C1C-AE38-46FA-A854-BB425B55BEF4.html["서비스 품질 정책"^] 내용은 _NetApp Element 사용 설명서_ 를 참조하십시오.
...
* https://docs.netapp.com/sfe-122/index.jsp["NetApp SolidFire 및 Element 문서 센터"^]
