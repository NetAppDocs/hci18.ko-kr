...
----
. 버전이 일치하지 않으면 운영체제를 업그레이드해야 합니다. 자세한 내용은 link:https://community.mellanox.com/s/article/howto-upgrade-switch-os-software-on-mellanox-switch-systems["Mellanox 소프트웨어 업그레이드 가이드"^]을 참조하십시오.
...
교체 스위치를 구성하는 단계를 수행하십시오. 자세한 내용은 link:https://docs.mellanox.com/display/MLNXOSv381000/Configuration+Management["Mellanox 구성 관리"^]을 참조하십시오.
