...
* https://library.netapp.com/ecm/ecm_download_file/ECMLP2885734["vCenter Plug-in 5.1 릴리즈 노트"^] _신규_
...
* link:rn_firmware_12.2.109.html["Compute Firmware Bundle 12.2.109 릴리스 정보"]
* link:firmware_driver_versions.html["지원되는 펌웨어 및 ESXi 드라이버 버전"] _신규_
